...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { description: @deck.description, legion1: @deck.legion1, legion2: @deck.legion2, tier: @deck.tier } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { description: @deck.description, legion1: @deck.legion1, legion2: @deck.legion2, tier: @deck.tier } }
